...
Enum CompressionLevels 'for compression/decompression
    ...
    Z_DEFAULT_COMPRESSION = 9
End Enum

  Property Get ValueCompressedSize() As Long
...
End Property
  ...
  Property Get ValueDecompressedSize() As Long
...
End Property
  ...
  Function CompressByteArray(TheData() As Byte, CompressionLevel As Integer) As Long
...
End Function
  ...
  Function CompressString(Text As String, CompressionLevel As Integer) As Long
    'compress a string
...
CompressionLevel = 9
    ...
    lngReturnValue = compress2(ByVal strTBuff, lngCmpSize, ByVal Text, Len(Text), Val(CompressionLevel))
    ...
    'return error code (if any)
    CompressString = ValueCompressedSize
    
End Function

  Function DecompressByteArray(TheData() As Byte, OriginalSize As Long) As Long
...
End Function
  ...
  Function DecompressString(Text As String, OriginalSize As Long) As Long
    'decompress a string
    Dim lngResult As Long
    Dim lngCmpSize As Long
    Dim strTBuff As String
...
End Function
  Function CompressFile(FilePathIn As String, FilePathOut As String, CompressionLevel As Integer) As Long
    FilePathIn = FilePathIn
    FilePathOut = FilePathOut
    CompressionLevel = Val(9)
...
End Function
  ...
  Function DecompressFile(FilePathIn As String, FilePathOut As String) As Long
